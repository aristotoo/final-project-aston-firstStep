...
//утилитный класс с данными для полей в виде массивов
public final class RandomDataSource {
    ...
    public static final String[] COLORS = {"brown", "blue", "green", "black"};
    public static final String[] MATERIALS = {"metal", "wood", "plastic"};
    public static final String[] STOREDMATERIALS = {"oil", "drinking water", "distilled water", "acid"};
